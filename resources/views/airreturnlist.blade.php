                                                        ...
                                                        <div class="col">
                                                            <div class="card_basic_info">
                                                                ...
                                                                <div class="price_box col-md-3 md_left  d-flex justify-content-between align-items-center flex-column">
                                                                    @php
                                                                    $dd = ($c->discount)/100;
                                                                    $price = round(($c->kms*($c->rates)*2)+(($c->kms*($c->rates)*2)*0.05)+($c->toll_tax*2));
                                                                    ...
                                                                    <form action="/booking" method="post">
                                                                        ...
                                                                        <input type="hidden" value="{{$tripmeta['pickup']}}" name="drop">
                                                                        <input type="hidden" value="{{$tripmeta['airport']}}" name="airport">
                                                                        <input type="hidden" value="{{$c->id}}" name="packcode">
                                                                        <input type="hidden" value="{{$tripmeta['triptype']}}" name="triptype">
                                                                        <input type="hidden" value="{{$price}}" name="price">
                                                                        <input type="hidden" value="{{$c->toll_tax * 2}}" name="toll_tax">
