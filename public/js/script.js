...
(function ($) {
  ...
  jQuery(".header-sidebar .menu-title").append(
  ...
  $(
    ...
    ".order-menu-section .qty-right-plus, .order-cart-right .qty-right-plus"
  ...
  $(
    ...
    ".order-menu-section .qty-left-minus, .order-cart-right .qty-left-minus"
  ...
  $(".open-select").click(function () {
    ...
    $(this)
      ...
      .find(".selector-box, .selector-box-flight")
  ...
  $(".open-select-top-filteration").click(function () {

    $(this)

      .parent()

      .find(".selector-box-flight")
  ...
  $("input:radio[name=exampleRadios]").change(function () {
    ...
    if (this.value == "oneway") {
      ...
      document.getElementById("localtrip").style.display = "none";

      document.getElementById("airporttype").style.display = "none";
      ...
      document.getElementById("airporttype").style.display = "flex";

    } else if (this.value == "localtrip") {
      ...
      document.getElementById("localtrip").style.display = "block";
  ...
  $("input:radio[name=airporttype]").change(function () {
...
$(document).mouseup(function (e) {
  ...
  var container = $(
    ...
    ".open-select, .selector-box, .selector-box-flight, .fare-calender, .setting"
  ...
  if (!container.is(e.target) && container.has(e.target).length === 0) {
    ...
    $(
      ...
      ".selector-box, .selector-box-flight, .calender-external, .setting-open"
...
$(document).ready(function() {
  ...
  $('.txtmid input:radio').change(function() {
